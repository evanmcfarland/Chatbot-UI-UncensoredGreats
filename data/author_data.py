...
AUTHOR_INFO = {
    ...
    "last": "tilak",
    "image": "balpfp.png",
    "description": "🌏 Indian Nationalist & Social Reformer (1856-1920) | 🕰️ Extremist of My Day, Moderate of Yesterday, Revolutionist of Today | 🧭 Rediscovered the Arctic Origins of Indo-Aryan Humans | ✨ \"It may be Providence's will that the cause I represent prospers more by my suffering than by my remaining free.\"",
    "books": [
                "Address to the Indian National Congress",
                "Collection of Bal Gangadhar Tilak Writings and Speeches",
                "Orion, or, Researches into the Antiquity of the Vedas",
                "Srimad Bhagavad Gita Rahasya Volume 1",
                "Srimad Bhagavad Gita Rahasya Volume 2",
                "The Arctic Home in the Vedas"
            ],
    "sentences_json": "https://raw.githubusercontent.com/evanmcfarland/A-Statistical-Approach-to-Happiness/main/data/Bal%20Tilak/bal_books_sentences.json",
    "segments_json": "https://raw.githubusercontent.com/evanmcfarland/A-Statistical-Approach-to-Happiness/main/data/Bal%20Tilak/bal_books_segments.json",
    "paragraphs_json": "https://raw.githubusercontent.com/evanmcfarland/A-Statistical-Approach-to-Happiness/main/data/Bal%20Tilak/bal_books_paragraphs.json"
    },
    "Camille Flammarion": {
    ...
    "description": "_🇫🇷 Astronomer & Popular Science Writer (1842-1925) | 🔭 Author of the first popular astronomy book | 📚 Wrote over 100 books on science, philosophy, & history | 👽 Mixing Science and Mysticism, Psychology and Spirit, Astrology and Wisdom | 📜 \"The universe is a great machine, and the human mind is a great key.\"_",
    "books": [
                "Astronomical Myths",
    ...
    "last": "jung",
    "image": "carlpfp.png",
    "description": "_🇨🇭 Psychiatrist & Psychoanalyst (1875-1961) | 🌐 Founder of Analytical Psychology | 🧠 Pioneer of the collective unconscious, archetypes, & individuation | 🌀 \"Show me a sane man and I will cure him for you.\"_",
    ...
    "last": "darwin",
    "image": "darwinpfp.png",
    "description": "_🇬🇧 Naturalist & Evolutionary Biologist (1809-1882) | 🐒 Originator of the theory of evolution by natural selection | 📚 Wrote 20 books on evolution, geology, & biology | 🐦 \"It is not the strongest of the species that survives, nor the most intelligent that survives. It is the one that is the most adaptable to change.\"_",
    ...
    "description": "_🇩🇪 Philosopher & Cultural Critic (1844-1900) | 📚 Exploring ethics, metaphysics, epistemology, nihilism, & aesthetics | 🔥 Champion of individualism & self-overcoming | ⚰️ \"God is dead, God remains dead, and we have killed him.\"_",
    "books": [  "Beyond Good and Evil", 
                "Early Greek Philosophy and Other Essays Collected Works Volume II",
                "Ecce Homo",
    ...
    "Fyodor Dostoevsky": {
        ...
        "description": "_🇷🇺 Novelist & Philosopher (1821-1881) | 📚 Wrote on the human condition & the struggle between good & evil | 💀 From near-execution to literary greatness: Dostoevsky's fearless critiques of the Tsarist regime. | 📖 \"The degree of civilization in a society can be judged by entering its prisons.\"_",
        "books": [   
    ...
    "Henry Thoreau": {
        ...
        "description": "_🇺🇸 Philosopher & Naturalist (1817-1862) | 📚 Wrote on the importance of nature, self-reliance, and simplicity | 🌲 Lived in a cabin in the woods for two years | 🍃 I show how we all live shares little resemblance with how we ought to live  | 💡 \"I went to the woods because I wished to live deliberately, to front only the essential facts of life, and see if I could not learn what it had to teach, and not, when I came to die, discover that I had not lived.\"_",
    ...
    "Herman Melville": {
        ...
        "description": "_🇺🇸 Masterful Author & Storyteller (1819-1891) | 📚 Unraveling the depths of human experience | 🐋 Redefined American literature with Moby-Dick | 🌊 Explored life at sea & society's complexities | ✍️ Wrote on culture, philosophy, and human nature | 💡 Bridged the realms of fiction and reality | 📖 \"It is better to fail in originality than to succeed in imitation.\"_",
    ...
    "Jane Austen": {
        ...
        "last": "austen",
        "image": "austenpfp.png",
        "description": "_📚 English Novelist of Manners (1775-1817) | ✍️ Author of Pride & Prejudice, Sense & Sensibility, Emma, & Persuasion | 🍃 Masterfully dissecting social norms with wit | 📖 \"I declare after all there is no enjoyment like reading! How much sooner one tires of anything than of a book!\"_",
        "books": [
                "Emma",
                "Lady Susan",
                "Love and Friendship",
    ...
    "John Dewey": {
        ...
        "last": "dewey",
        "image": "deweypfp.png",
        "description": "_🇺🇸 American Philosopher & Educator (1859-1952) | 🎭 Educator, Founder of the Philosophical School of Pragmatism, Avid Supporter of the Arts | 📚 Author of Democracy & Education, Experience & Nature, & The Public and Its Problems | 📖 \"Education is not preparation for life; education is life itself.\"_",
        "books": [
                "A Common Faith",
    ...
    "Mary Shelley": {
        ...
        "last": "shelley",
        "image": "marypfp.png",
        "description": "_British Novelist (1797-1851) | 👩‍🔬 Mother of Science Fiction | 📚 Author of Frankenstein | 💭 Delving into the human condition, the consequences of scientific progress, & pushing the boundaries of literature | 🖋️ Bold, groundbreaking storyteller | 🌩️ \"Beware; for I am fearless, and therefore powerful.\"_",
    ...
    "Richard Wagner": {
        ...
        "last": "richard",
        "image": "wagnerpfp.png",
        "description": "_🇩🇪 Renaissance Man & Composer (1813-1883) | 🎼 Unveiling the creative process | 🎵 Redefined the concept of music and opera | 🎭 Influenced the modern theatrical form | 📚 Wrote on music, philosophy, and politics | 💡 Bridged the arts, sciences, and humanities | 🎶 \"Music is the language of the heart without words.\"_",
        "books" : [
    ...
    "Thoth & Hermes Trismegistus": {
        ...
        "last": "trismegistus",
        "image": "hermespfp.png",
        "description": "_Ancient Egyptian God of Wisdom (6000-2000 BCE) | 📜 Divine scribe & god of wisdom | 🖋️ Inventor of writing, magic & the lunar calendar 🌙 | Maintaining cosmic balance ⚖️ | Reincarnated in Greece as the Messenger of Gods (1600-300BCE) | ✍️ Syncretic sage & author of Hermetic texts | Fusing Greek & Egyptian wisdom🔮 \"As above, so below; as within, so without.\" | Embodying the secrets of the universe🌌_",
    ...
    "Voltaire": {
        ...
        "description": "_🇫🇷 François-Marie Arouet: Acclaimed Satirist & Enlightenment Luminary (1694-1778) | 📚 As the Sage of Ferney, my wit and wisdom have left an indelible mark | ⚔️🗽 I fought against tyranny with every breath | 🌟 My passion for human rights inspired the French Revolution | 📚 Through satire, I challenged society's ills and shaped social reform | 🎇 Seeded the philosophy of the Enlightenment, nurturing reason and intellectual curiosity | 🖋️ \"I may not agree with what you say, but I will defend to the death your right to say it - that is the legacy I leave behind!\"_",
        "books": [   
    ...
    "William Shakespeare": {
        ...
        "description": "_🇬🇧 Master of Intrigue & Timeless Tales (1564-1616) | 🎭 The Bard of Avon, creator of iconic characters | 🌟 Enriched the English language with countless phrases & expressions | 📚 Whose plays inspired generations of writers, composers, & filmmakers | 💕 Wove romance, tragedy, & comedy into unforgettable stories | 🌍 Famed for depicting the human condition with unrivaled insight | 🎭 \"To be or not to be, that's the question I'll forever be remembered for!\"_",
        "books" : [
...
file_path = 'C:/Users/evanm/Chatbot-UI-UncensoredGreats/data/author_data.json'
